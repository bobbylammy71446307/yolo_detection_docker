...
# Use TCP for reliability and allow some buffering to handle network jitter
os.environ['OPENCV_FFMPEG_CAPTURE_OPTIONS'] = 'rtsp_transport;tcp|buffer_size;1024000|max_delay;500000|hwaccel;rkmpp'

# Enable Rockchip MPP (Media Process Platform) hardware decoder
# This tells FFMPEG to use the hardware H.264/H.265 decoder on RK3588
os.environ['OPENCV_VIDEOIO_PRIORITY_FFMPEG'] = '1'  # Prefer FFMPEG backend
    ...
    try:
        while True:
            ...
            if success:
                ...
                # Skip frames - only process every frame_skip frames
